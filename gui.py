...
select_button = ttk.Button(main_frame, text="Select File or Folder", command=select_path)
select_button.pack(pady=10)
path_entry = ttk.Entry(main_frame, textvariable=selected_path, width=80, state='readonly')
path_entry.pack(pady=10)
grant_button = ttk.Button(main_frame, text="Get Access", command=grant_permissions)
grant_button.pack(pady=20)

# Create UI elements for the history tab
history_label = ttk.Label(history_frame, text="History of Permissions Changes")
